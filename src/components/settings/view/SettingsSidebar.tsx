import { Bell, Bot, Eye, GitBranch, Info, Key, ListChecks, Mic, MonitorPlay, Palette, Puzzle } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'visionBridge', labelKey: 'mainTabs.visionBridge', icon: Eye },
